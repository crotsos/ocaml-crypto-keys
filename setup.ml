...
(* OASIS_START *)
(* DO NOT EDIT (digest: 041dc6dc13d597a39675309bf795348c) *)
(*
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "A library to transform public key files between different\nformats";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("cryptokit", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["binding_ssl_ext.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-O2"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lssl"])];
